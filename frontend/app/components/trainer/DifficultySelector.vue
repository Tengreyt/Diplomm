...
const styles = tv({
  slots: {
    ...
    trigger: [
      "glass-control inline-flex h-10 min-w-[156px] items-center justify-between gap-3 rounded-2xl px-4 text-sm font-semibold text-accent-deep transition",
    ...
    menu: [
      "glass-panel absolute right-0 top-[calc(100%+0.5rem)] z-20 flex w-60 flex-col gap-2 rounded-2xl p-2 text-left",
    ],
    optionButton: [
      "glass-control w-full rounded-xl px-3 py-2.5 text-left transition",
    ...
    description: ["rounded-xl bg-white/60 px-3 py-2 text-xs leading-5 text-muted"],
  },
  variants: {
    active: {
      true: {
